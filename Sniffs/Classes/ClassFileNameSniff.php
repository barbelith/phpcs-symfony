<?php
/**
 * Adapted from Squiz_Sniffs_Classes_ClassFileNameSniff
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Symfony_Sniffs_Classes_ClassFileNameSniff implements PHP_CodeSniffer_Sniff
{
  /**
  ...
  public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
  {
    ...
    $fileName = substr($fullPath, 0, strrpos($fullPath, '.class'));
