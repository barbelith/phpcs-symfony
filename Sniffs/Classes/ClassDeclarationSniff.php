<?php
/**
 * Adapted from Squiz_Sniffs_Classes_ClassDeclarationSniff
 *
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Symfony_Sniffs_Classes_ClassDeclarationSniff extends PEAR_Sniffs_Classes_ClassDeclarationSniff
{
